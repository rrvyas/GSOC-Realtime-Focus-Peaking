# 
# Project automation script for gsoc_3 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source gsoc.tcl), then you can
...
set myProject "gsoc_3"
set myScript "gsoc.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../../gsoc/RGBGr.vhd"
   xfile add "../../gsoc/kernel_top.vhd"
   xfile add "../../gsoc/line_buffer_one_two.vhd"
   xfile add "../../gsoc/sobel_kernel.vhd"
   xfile add "../line_buffer_test.vhd"
   xfile add "../sobel_test.vhd"
   xfile add "top_kernel_tb.vhd"

   # Set the Top Module as well...
   project set top "Behavioral" "kernel_top"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/pdp/Desktop/gsoc_3/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "kernel_top" -process "Generate IBIS Model"
